...
public class PWDresthouse_home_searchpage {
	WebDriver driver;
	...
	public PWDresthouse_home_searchpage(WebDriver driver) {
		this.driver=driver;
	}
    ...
    WebElement roomtypeelement=driver.findElement(Roomtype);
			...
			obj2.selectByValue("7");
	         ...
	         public void datepicker() throws Exception
	         {
	     		...
	     		driver.findElement(datepickerin).sendKeys("28-04-2024");
	     		Thread.sleep(1000);
	     		driver.findElement(datepickerout).sendKeys("30-04-2024");
	     		Thread.sleep(1000);
